    ...
    if self.skillId and self.subSkillId then
      ...
      if hurtNum then
        ...
        if 0 ~= num then
          ...
          hurtUnit:SaveDamaged(num, attackUnit.uid ~= hurtUnit.uid, nil, attackUnit.camp == hurtUnit.enemyCamp)
      ...
      if hurtExtraParams.counter then
        ...
        if counterValue and true == attackUnit:CanTargetChosen() then
          ...
          if 0 ~= num then
            ...
            attackUnit:SaveDamaged(num, nil, nil, hurtUnit.camp == attackUnit.enemyCamp)
