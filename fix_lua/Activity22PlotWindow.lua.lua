...
function Activity22PlotWindow.OnInit(bridgeObj)
  bridgeObj:SetViewAsync(WinResConfig.Activity22PlotWindow.package, WinResConfig.Activity22PlotWindow.comName, function(com)
    contentPane = com
    contentPane:Center()
    uis = GetActivityDungeon1022_PlotWindowUis(contentPane)
    local storyId = bridgeObj.argTable[1]
    configData = bridgeObj.argTable[2]
    Activity22PlotWindow.UpdateInfo(storyId)
    Activity22PlotWindow.InitBtn()
  end)
end

function Activity22PlotWindow.UpdateInfo(storyId)
...
function Activity22PlotWindow.InitBtn()
  uis.Main.ReturnBtn.onClick:Set(Activity22PlotWindow.CloseWindow)
...
function Activity22PlotWindow.CloseWindow()
  UIMgr:CloseWindow(WinResConfig.Activity22PlotWindow.name)
end

function Activity22PlotWindow.OnClose()
  uis = nil
  contentPane = nil
  configData = nil
end

return Activity22PlotWindow
