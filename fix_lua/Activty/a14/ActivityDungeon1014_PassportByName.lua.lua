...
function GetActivityDungeon1014_PassportUis(ui)
  ...
  uis.RewardRegion = GetActivityDungeon1014_PassReward_RewardRegionUis(ui:GetChild("RewardRegion"))
  uis.TaskRegion = GetActivityDungeon1014_PassTask_TaskRegionUis(ui:GetChild("TaskRegion"))
  uis.ClothseRegion = GetActivityDungeon1014_PassClothes_ClothseRegionUis(ui:GetChild("ClothseRegion"))
  uis.Level = GetActivityDungeon1014_Passport_LevelUis(ui:GetChild("Level"))
  uis.Time = GetActivityDungeon1014_Sign_TimeUis(ui:GetChild("Time"))
  uis.AllGetBtn = ui:GetChild("AllGetBtn")
  uis.TabRegion = GetActivityDungeon1014_Passport_TabRegionUis(ui:GetChild("TabRegion"))
