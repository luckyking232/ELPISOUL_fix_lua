...
function Activity14MaterialWindow.OnInit(bridgeObj)
  bridgeObj:SetViewAsync(WinResConfig.Activity14MaterialWindow.package, WinResConfig.Activity14MaterialWindow.comName, function(com)
    contentPane = com
    contentPane:Center()
    uis = GetActivityDungeon1014_MaterialWindowUis(contentPane)
...
function Activity14MaterialWindow.UpdateInfo()
  activityInfo = ActivityDungeonData.GetActivityInfo()
  maxCount = Activity14MaterialWindow.GetMaxCount()
  if activityInfo then
    local id = Activity14MaterialWindow.GetChapter()
    if id then
...
function Activity14MaterialWindow.GetChapter()
  for i, v in pairs(activityInfo.creamChapter) do
    return i
  end
end

function Activity14MaterialWindow.GetMaxCount()
...
function Activity14MaterialWindow.InitBtn()
  uis.Main.ReturnBtn.onClick:Set(Activity14MaterialWindow.CloseWindow)
end

function Activity14MaterialWindow.CloseWindow()
  UIMgr:CloseWindow(WinResConfig.Activity14MaterialWindow.name)
end

function Activity14MaterialWindow.OnShown()
  if uis then
    Activity14MaterialWindow.UpdateInfo()
  end
end

function Activity14MaterialWindow.OnClose()
  uis = nil
  contentPane = nil
  activityInfo = nil
end

return Activity14MaterialWindow
