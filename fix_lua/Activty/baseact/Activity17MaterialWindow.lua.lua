...
function Activity17MaterialWindow.OnInit(bridgeObj)
  bridgeObj:SetViewAsync(WinResConfig.Activity17MaterialWindow.package, WinResConfig.Activity17MaterialWindow.comName, function(com)
    contentPane = com
    contentPane:Center()
    uis = GetActivityDungeon1017_MaterialWindowUis(contentPane)
...
function Activity17MaterialWindow.UpdateInfo()
  activityInfo = ActivityDungeonData.GetActivityInfo()
  maxCount = Activity17MaterialWindow.GetMaxCount()
  if activityInfo then
    local id = Activity17MaterialWindow.GetChapter()
    if id then
...
function Activity17MaterialWindow.GetChapter()
  for i, v in pairs(activityInfo.creamChapter) do
    return i
  end
end

function Activity17MaterialWindow.GetMaxCount()
...
function Activity17MaterialWindow.InitBtn()
  uis.Main.ReturnBtn.onClick:Set(Activity17MaterialWindow.CloseWindow)
end

function Activity17MaterialWindow.CloseWindow()
  UIMgr:CloseWindow(WinResConfig.Activity17MaterialWindow.name)
end

function Activity17MaterialWindow.OnShown()
  if uis then
    Activity17MaterialWindow.UpdateInfo()
  end
end

function Activity17MaterialWindow.OnClose()
  uis = nil
  contentPane = nil
  activityInfo = nil
end

return Activity17MaterialWindow
