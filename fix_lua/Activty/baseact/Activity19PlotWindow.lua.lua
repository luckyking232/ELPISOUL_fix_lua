...
function Activity19PlotWindow.OnInit(bridgeObj)
  bridgeObj:SetViewAsync(WinResConfig.Activity19PlotWindow.package, WinResConfig.Activity19PlotWindow.comName, function(com)
    contentPane = com
    contentPane:Center()
    uis = GetActivityDungeon1019_PlotWindowUis(contentPane)
    local storyId = bridgeObj.argTable[1]
    configData = bridgeObj.argTable[2]
    Activity19PlotWindow.UpdateInfo(storyId)
    Activity19PlotWindow.InitBtn()
  end)
end

function Activity19PlotWindow.UpdateInfo(storyId)
...
function Activity19PlotWindow.InitBtn()
  uis.Main.ReturnBtn.onClick:Set(Activity19PlotWindow.CloseWindow)
...
function Activity19PlotWindow.CloseWindow()
  UIMgr:CloseWindow(WinResConfig.Activity19PlotWindow.name)
end

function Activity19PlotWindow.OnClose()
  uis = nil
  contentPane = nil
  configData = nil
end

return Activity19PlotWindow
