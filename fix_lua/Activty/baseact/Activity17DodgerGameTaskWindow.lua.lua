...
function Activity17DodgerGameTaskWindow.ReInitData()
end

function Activity17DodgerGameTaskWindow.OnInit(bridgeObj)
  bridgeObj:SetViewAsync(WinResConfig.Activity17DodgerGameTaskWindow.package, WinResConfig.Activity17DodgerGameTaskWindow.comName, function(com)
    contentPane = com
    contentPane:Center()
    uis = GetActivityDungeon1017_MiniTaskWindowUis(contentPane)
    Activity17DodgerGameTaskWindow.UpdateInfo()
    Activity17DodgerGameTaskWindow.InitBtn()
  end)
end

function Activity17DodgerGameTaskWindow.UpdateInfo()
  RefreshRewardList()
  local info = Activity17_MiniGameData.GetMiniGameInfo(gameId)
...
function Activity17DodgerGameTaskWindow.InitBtn()
  uis.Main.ReturnBtn.onClick:Set(function()
    UIMgr:CloseWindow(WinResConfig.Activity17DodgerGameTaskWindow.name)
  end)
end

function Activity17DodgerGameTaskWindow.OnClose()
  uis = nil
  contentPane = nil
end

return Activity17DodgerGameTaskWindow
