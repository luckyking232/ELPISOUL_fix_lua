...
function Activity13PlotWindow.OnInit(bridgeObj)
  bridgeObj:SetViewAsync(WinResConfig.Activity13PlotWindow.package, WinResConfig.Activity13PlotWindow.comName, function(com)
    contentPane = com
    contentPane:Center()
    uis = GetActivityDungeon1013_PlotWindowUis(contentPane)
    local storyId = bridgeObj.argTable[1]
    configData = bridgeObj.argTable[2]
    Activity13PlotWindow.UpdateInfo(storyId)
    Activity13PlotWindow.InitBtn()
  end)
end

function Activity13PlotWindow.UpdateInfo(storyId)
...
function Activity13PlotWindow.InitBtn()
  uis.Main.ReturnBtn.onClick:Set(Activity13PlotWindow.CloseWindow)
...
function Activity13PlotWindow.CloseWindow()
  UIMgr:CloseWindow(WinResConfig.Activity13PlotWindow.name)
end

function Activity13PlotWindow.OnClose()
  uis = nil
  contentPane = nil
  configData = nil
end

return Activity13PlotWindow
