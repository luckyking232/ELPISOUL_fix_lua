...
function Activity11PlotWindow.OnInit(bridgeObj)
  bridgeObj:SetViewAsync(WinResConfig.Activity11PlotWindow.package, WinResConfig.Activity11PlotWindow.comName, function(com)
    contentPane = com
    contentPane:Center()
    uis = GetActivityDungeon1011_PlotWindowUis(contentPane)
    local storyId = bridgeObj.argTable[1]
    configData = bridgeObj.argTable[2]
    Activity11PlotWindow.UpdateInfo(storyId)
    Activity11PlotWindow.InitBtn()
  end)
end

function Activity11PlotWindow.UpdateInfo(storyId)
...
function Activity11PlotWindow.InitBtn()
  uis.Main.ReturnBtn.onClick:Set(Activity11PlotWindow.CloseWindow)
...
function Activity11PlotWindow.CloseWindow()
  UIMgr:CloseWindow(WinResConfig.Activity11PlotWindow.name)
end

function Activity11PlotWindow.OnClose()
  uis = nil
  contentPane = nil
  configData = nil
end

return Activity11PlotWindow
