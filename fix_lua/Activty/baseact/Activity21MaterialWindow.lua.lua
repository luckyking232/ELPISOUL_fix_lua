...
function Activity21MaterialWindow.OnInit(bridgeObj)
  bridgeObj:SetViewAsync(WinResConfig.Activity21MaterialWindow.package, WinResConfig.Activity21MaterialWindow.comName, function(com)
    contentPane = com
    contentPane:Center()
    uis = GetActivityDungeon1021_MaterialWindowUis(contentPane)
...
function Activity21MaterialWindow.UpdateInfo()
  activityInfo = ActivityDungeonData.GetActivityInfo()
  maxCount = Activity21MaterialWindow.GetMaxCount()
  if activityInfo then
    local id = Activity21MaterialWindow.GetChapter()
    if id then
...
function Activity21MaterialWindow.GetChapter()
  for i, v in pairs(activityInfo.creamChapter) do
    return i
  end
end

function Activity21MaterialWindow.GetMaxCount()
...
function Activity21MaterialWindow.InitBtn()
  uis.Main.ReturnBtn.onClick:Set(Activity21MaterialWindow.CloseWindow)
end

function Activity21MaterialWindow.CloseWindow()
  UIMgr:CloseWindow(WinResConfig.Activity21MaterialWindow.name)
end

function Activity21MaterialWindow.OnShown()
  if uis then
    Activity21MaterialWindow.UpdateInfo()
  end
end

function Activity21MaterialWindow.OnClose()
  uis = nil
  contentPane = nil
  activityInfo = nil
end

return Activity21MaterialWindow
