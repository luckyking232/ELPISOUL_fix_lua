...
function Activity5MiniGameTaskWindow.ReInitData()
end

function Activity5MiniGameTaskWindow.OnInit(bridgeObj)
  bridgeObj:SetViewAsync(WinResConfig.Activity5MiniGameTaskWindow.package, WinResConfig.Activity5MiniGameTaskWindow.comName, function(com)
    contentPane = com
    contentPane:Center()
    uis = GetActivityDungeon1004_MiniTaskWindowUis(contentPane)
    Activity5MiniGameTaskWindow.UpdateInfo()
    Activity5MiniGameTaskWindow.InitBtn()
  end)
end

function Activity5MiniGameTaskWindow.UpdateInfo()
  local info = Activity5_MiniGameData.GetMiniGameInfo(gameId)
...
function Activity5MiniGameTaskWindow.InitBtn()
  uis.Main.ReturnBtn.onClick:Set(function()
    UIMgr:CloseWindow(WinResConfig.Activity5MiniGameTaskWindow.name)
  end)
end

function Activity5MiniGameTaskWindow.OnClose()
  uis = nil
  contentPane = nil
end

return Activity5MiniGameTaskWindow
