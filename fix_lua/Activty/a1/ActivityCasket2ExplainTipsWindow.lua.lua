...
function ActivityCasket2ExplainTipsWindow.OnInit(bridgeObj)
  bridgeObj:SetViewAsync(WinResConfig.ActivityCasket2ExplainTipsWindow.package, WinResConfig.ActivityCasket2ExplainTipsWindow.comName, function(com)
    contentPane = com
    contentPane:Center()
    uis = GetActivityCasket01_ExplainTipsWindowUis(contentPane)
...
function ActivityCasket2ExplainTipsWindow.UpdateInfo()
...
function ActivityCasket2ExplainTipsWindow.ShowShop()
...
function ActivityCasket2ExplainTipsWindow.ShowRule()
...
function ActivityCasket2ExplainTipsWindow.ShowRecord()
  ...
  local data = ActivityCasket2ExplainTipsWindow.GetCost(turnTableConfig.group_id)
  ...
  function tips.ContentList.itemRenderer(i, item)
    if data[i + 1].reward then
      ...
      if arr[1] then
        ...
        local poolInfo = ActivityCasket2ExplainTipsWindow.GetPoolInfo(turnTableInfo.pools, data[i + 1].id)
        if poolInfo then
...
function ActivityCasket2ExplainTipsWindow.GetPoolInfo(pools, id)
...
function ActivityCasket2ExplainTipsWindow.GetCost(groupId)
...
function ActivityCasket2ExplainTipsWindow.InitBtn()
  ...
  uis.Main.TouchScreenBtn.onClick:Set(function()
    UIMgr:CloseWindow(WinResConfig.ActivityCasket2ExplainTipsWindow.name)
  end)
end

function ActivityCasket2ExplainTipsWindow.OnClose()
  uis = nil
  contentPane = nil
  turnTableConfig = nil
  turnTableInfo = nil
...
function ActivityCasket2ExplainTipsWindow.HandleMessage(msgId, para)
  if msgId == WindowMsgEnum.ActivityCasket.REFRESH_PAY_SHOP then
    ActivityCasket2ExplainTipsWindow.ShowShop()
  end
end

return ActivityCasket2ExplainTipsWindow
