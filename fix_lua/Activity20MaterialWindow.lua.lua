...
function Activity20MaterialWindow.OnInit(bridgeObj)
  bridgeObj:SetViewAsync(WinResConfig.Activity20MaterialWindow.package, WinResConfig.Activity20MaterialWindow.comName, function(com)
    contentPane = com
    contentPane:Center()
    uis = GetActivityDungeon1020_MaterialWindowUis(contentPane)
...
function Activity20MaterialWindow.UpdateInfo()
  activityInfo = ActivityDungeonData.GetActivityInfo()
  maxCount = Activity20MaterialWindow.GetMaxCount()
  if activityInfo then
    local id = Activity20MaterialWindow.GetChapter()
    if id then
...
function Activity20MaterialWindow.GetChapter()
  for i, v in pairs(activityInfo.creamChapter) do
    return i
  end
end

function Activity20MaterialWindow.GetMaxCount()
...
function Activity20MaterialWindow.InitBtn()
  uis.Main.ReturnBtn.onClick:Set(Activity20MaterialWindow.CloseWindow)
end

function Activity20MaterialWindow.CloseWindow()
  UIMgr:CloseWindow(WinResConfig.Activity20MaterialWindow.name)
end

function Activity20MaterialWindow.OnShown()
  if uis then
    Activity20MaterialWindow.UpdateInfo()
  end
end

function Activity20MaterialWindow.OnClose()
  uis = nil
  contentPane = nil
  activityInfo = nil
end

return Activity20MaterialWindow
