...
function Activity22MaterialWindow.OnInit(bridgeObj)
  bridgeObj:SetViewAsync(WinResConfig.Activity22MaterialWindow.package, WinResConfig.Activity22MaterialWindow.comName, function(com)
    contentPane = com
    contentPane:Center()
    uis = GetActivityDungeon1022_MaterialWindowUis(contentPane)
...
function Activity22MaterialWindow.UpdateInfo()
  activityInfo = ActivityDungeonData.GetActivityInfo()
  maxCount = Activity22MaterialWindow.GetMaxCount()
  if activityInfo then
    local id = Activity22MaterialWindow.GetChapter()
    if id then
...
function Activity22MaterialWindow.GetChapter()
  for i, v in pairs(activityInfo.creamChapter) do
    return i
  end
end

function Activity22MaterialWindow.GetMaxCount()
...
function Activity22MaterialWindow.InitBtn()
  uis.Main.ReturnBtn.onClick:Set(Activity22MaterialWindow.CloseWindow)
end

function Activity22MaterialWindow.CloseWindow()
  UIMgr:CloseWindow(WinResConfig.Activity22MaterialWindow.name)
end

function Activity22MaterialWindow.OnShown()
  if uis then
    Activity22MaterialWindow.UpdateInfo()
  end
end

function Activity22MaterialWindow.OnClose()
  uis = nil
  contentPane = nil
  activityInfo = nil
end

return Activity22MaterialWindow
