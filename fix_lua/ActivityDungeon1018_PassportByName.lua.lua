...
function GetActivityDungeon1018_PassportUis(ui)
  ...
  uis.RewardRegion = GetActivityDungeon1018_PassReward_RewardRegionUis(ui:GetChild("RewardRegion"))
  uis.TaskRegion = GetActivityDungeon1018_PassTask_TaskRegionUis(ui:GetChild("TaskRegion"))
  uis.ClothseRegion = GetActivityDungeon1018_PassClothes_ClothseRegionUis(ui:GetChild("ClothseRegion"))
  uis.Level = GetActivityDungeon1018_Passport_LevelUis(ui:GetChild("Level"))
  uis.Time = GetActivityDungeon1018_Sign_TimeUis(ui:GetChild("Time"))
  uis.AllGetBtn = ui:GetChild("AllGetBtn")
  uis.TabRegion = GetActivityDungeon1018_Passport_TabRegionUis(ui:GetChild("TabRegion"))
