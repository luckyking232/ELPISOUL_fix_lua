...
function GetRogueBuild01_Map_S001Uis(ui)
  ...
  uis.Dot_C_01 = GetRogueBuild01_InsideMapEvent_CampUis(ui:GetChild("Dot_C_01"))
  uis.Dot_D_01 = GetRogueBuild01_InsideMapEvent_Battle2Uis(ui:GetChild("Dot_D_01"))
  uis.Dot_E_01 = GetRogueBuild01_InsideMapEvent_PlotUis(ui:GetChild("Dot_E_01"))
