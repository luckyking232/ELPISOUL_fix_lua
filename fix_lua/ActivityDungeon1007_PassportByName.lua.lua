...
function GetActivityDungeon1007_PassportUis(ui)
  ...
  uis.RewardRegion = GetActivityDungeon1007_PassReward_RewardRegionUis(ui:GetChild("RewardRegion"))
  uis.TaskRegion = GetActivityDungeon1007_PassTask_TaskRegionUis(ui:GetChild("TaskRegion"))
  uis.ClothseRegion = GetActivityDungeon1007_PassClothes_ClothseRegionUis(ui:GetChild("ClothseRegion"))
  uis.Level = GetActivityDungeon1007_Passport_LevelUis(ui:GetChild("Level"))
  uis.Time = GetActivityDungeon1007_Sign_TimeUis(ui:GetChild("Time"))
  uis.AllGetBtn = ui:GetChild("AllGetBtn")
  uis.TabRegion = GetActivityDungeon1007_Passport_TabRegionUis(ui:GetChild("TabRegion"))
