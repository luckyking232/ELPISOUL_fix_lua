...
function Activity13CarGameTaskWindow.ReInitData()
end

function Activity13CarGameTaskWindow.OnInit(bridgeObj)
  bridgeObj:SetViewAsync(WinResConfig.Activity13CarGameTaskWindow.package, WinResConfig.Activity13CarGameTaskWindow.comName, function(com)
    contentPane = com
    contentPane:Center()
    uis = GetActivityDungeon1013_MiniTask2WindowUis(contentPane)
    Activity13CarGameTaskWindow.UpdateInfo()
    Activity13CarGameTaskWindow.InitBtn()
  end)
end

function Activity13CarGameTaskWindow.UpdateInfo()
  RefreshRewardList()
  local gameId = 70441017
  local info = Activity13_MiniGameData.GetMiniGameInfo(gameId)
...
function Activity13CarGameTaskWindow.InitBtn()
  uis.Main.ReturnBtn.onClick:Set(function()
    UIMgr:CloseWindow(WinResConfig.Activity13CarGameTaskWindow.name)
  end)
end

function Activity13CarGameTaskWindow.OnClose()
  uis = nil
  contentPane = nil
end

return Activity13CarGameTaskWindow
