...
function Activity8MaterialWindow.OnInit(bridgeObj)
  bridgeObj:SetViewAsync(WinResConfig.Activity8MaterialWindow.package, WinResConfig.Activity8MaterialWindow.comName, function(com)
    contentPane = com
    contentPane:Center()
    uis = GetActivityDungeon1007_MaterialWindowUis(contentPane)
...
function Activity8MaterialWindow.UpdateInfo()
  activityInfo = ActivityDungeonData.GetActivityInfo()
  maxCount = Activity8MaterialWindow.GetMaxCount()
  if activityInfo then
    local id = Activity8MaterialWindow.GetChapter()
    if id then
...
function Activity8MaterialWindow.GetChapter()
  for i, v in pairs(activityInfo.creamChapter) do
    return i
  end
end

function Activity8MaterialWindow.GetMaxCount()
...
function Activity8MaterialWindow.InitBtn()
  uis.Main.ReturnBtn.onClick:Set(Activity8MaterialWindow.CloseWindow)
end

function Activity8MaterialWindow.CloseWindow()
  UIMgr:CloseWindow(WinResConfig.Activity8MaterialWindow.name)
end

function Activity8MaterialWindow.OnShown()
  if uis then
    Activity8MaterialWindow.UpdateInfo()
  end
end

function Activity8MaterialWindow.OnClose()
  uis = nil
  contentPane = nil
  activityInfo = nil
end

return Activity8MaterialWindow
