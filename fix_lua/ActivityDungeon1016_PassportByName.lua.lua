...
function GetActivityDungeon1016_PassportUis(ui)
  ...
  uis.RewardRegion = GetActivityDungeon1016_PassReward_RewardRegionUis(ui:GetChild("RewardRegion"))
  uis.TaskRegion = GetActivityDungeon1016_PassTask_TaskRegionUis(ui:GetChild("TaskRegion"))
  uis.ClothseRegion = GetActivityDungeon1016_PassClothes_ClothseRegionUis(ui:GetChild("ClothseRegion"))
  uis.Level = GetActivityDungeon1016_Passport_LevelUis(ui:GetChild("Level"))
  uis.Time = GetActivityDungeon1016_Sign_TimeUis(ui:GetChild("Time"))
  uis.AllGetBtn = ui:GetChild("AllGetBtn")
  uis.TabRegion = GetActivityDungeon1016_Passport_TabRegionUis(ui:GetChild("TabRegion"))
