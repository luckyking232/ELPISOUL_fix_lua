...
function Activity16PlotWindow.OnInit(bridgeObj)
  bridgeObj:SetViewAsync(WinResConfig.Activity16PlotWindow.package, WinResConfig.Activity16PlotWindow.comName, function(com)
    contentPane = com
    contentPane:Center()
    uis = GetActivityDungeon1016_PlotWindowUis(contentPane)
    local storyId = bridgeObj.argTable[1]
    configData = bridgeObj.argTable[2]
    Activity16PlotWindow.UpdateInfo(storyId)
    Activity16PlotWindow.InitBtn()
  end)
end

function Activity16PlotWindow.UpdateInfo(storyId)
...
function Activity16PlotWindow.InitBtn()
  uis.Main.ReturnBtn.onClick:Set(Activity16PlotWindow.CloseWindow)
...
function Activity16PlotWindow.CloseWindow()
  UIMgr:CloseWindow(WinResConfig.Activity16PlotWindow.name)
end

function Activity16PlotWindow.OnClose()
  uis = nil
  contentPane = nil
  configData = nil
end

return Activity16PlotWindow
