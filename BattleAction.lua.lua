          ...
          if true == defUnit:CanTargetChosen() or 1 == mainSkillLevelUpConfig.ignore_target_state then
            ...
            elseif bulletSpeed and bulletSpeed > 0 then
              ...
              if BattleBuffMgr.ContainEffectId(attackUnit, BUFF_EFFECT_ID.BULLET_CHANGE_THROUGH) then
                ...
                if attackUnit.summonId and (attackUnit.summonFromUnitId == SPECIAL_CARD_OR_MONSTER.LASITE or attackUnit.summonFromUnitId == SPECIAL_CARD_OR_MONSTER.FEI) then
              ...
              if hurtNum then
                ...
                if 0 ~= num then
                  ...
                  defUnit:SaveDamaged(num, attackUnit.uid ~= defUnit.uid, nil, attackUnit.camp == defUnit.enemyCamp)
              ...
              if hurtExtraParams.counter then
                ...
                if 0 ~= num then
                  ...
                  attackUnit:SaveDamaged(num, nil, nil, defUnit.camp == attackUnit.enemyCamp)
        ...
        if tempDamage > 0 and BattleBuffMgr.ContainEffectId(defUnit, BUFF_EFFECT_ID.SPECIAL_421) then
          ...
          if effect then
            ...
            if buffFromUnit then
              ...
              buffFromUnit:SaveDamaged(_buffEffectParams.hurt, nil, nil, attackUnit and attackUnit.camp == buffFromUnit.enemyCamp)
              if attackUnit then
...
function BattleAction.UpdateModelFlipWhenAttack(battleUnit)
  if battleUnit.summonFromUnitId == SPECIAL_CARD_OR_MONSTER.LASITE or battleUnit.summonFromUnitId == SPECIAL_CARD_OR_MONSTER.FEI then
